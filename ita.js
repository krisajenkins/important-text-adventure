...
Elm.Main.make = function (_elm) {
   ...
   var tick = F2(function (f,
   model) {
      return f(model.line) ? _U.replace([["column"
                                         ,model.column + 1]],
      model) : model;
   });
         ...
         {case "_Tuple2":
            switch (_v0._1.ctor)
              {case "[]":
                 return $Maybe.Nothing;}
              switch (_v0._0)
              {case 0: switch (_v0._1.ctor)
                   {case "::":
                      return $Maybe.Just(_v0._1._0);}
                   break;}
              break;}
         return A2(nth,
         n - 1,
   ...
   var wrap = function (model) {
      return function () {
         ...
         switch (_v5.ctor)
         {case "Just":
            return _U.cmp($String.length(_v5._0),
              model.column) < 0 ? wrap(_U.replace([["column"
                                                   ,0]
                                                  ,["line",model.line + 1]],
              model)) : model;
            case "Nothing":
            return _U.replace([["line",0]
                              ,["column",0]],
              model);}
         _U.badCase($moduleName,
   ...
   var windowOnAdventure = function (model) {
   ...
   _L.fromArray([A2($Html.span,
                _L.fromArray([$Html$Attributes.$class("fa fa-twitter")]),
                _L.fromArray([]))
                ,$Html.text(" Tweet This")]))]))]));
   var screenView = function (s) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.$class("screen well")]),
   ...
   var rootView = function (s) {
      ...
      _L.fromArray([A2($Html.h1,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Important Text Adventure")]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("row")]),
                   _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-md-8 col-md-offset-2")]),
                   _L.fromArray([screenView(windowOnAdventure(s))]))]))
                   ,A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("row")]),
                   _L.fromArray([A2($Html.div,
                   _L.fromArray([$Html$Attributes.$class("col-md-8 col-md-offset-2")]),
                   _L.fromArray([sharing]))]))]))]));
   };
   ...
   var Tick = {ctor: "Tick"};
   var gameTypes = A2($Signal.map,
   function (_v10) {
      return function () {
         return Tick;
      }();
   },
   $Time.every(75 * $Time.millisecond));
   var NoOp = {ctor: "NoOp"};
   var uiChannel = $Signal.channel(NoOp);
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,sharing: sharing
                      ,rootView: rootView
                      ,windowOnAdventure: windowOnAdventure
